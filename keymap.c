...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, MO(_NUMPAD), KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RALT, KC_RGUI, KC_APP,   KC_RCTL
),
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, _______, _______, KC_PSCR, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  RGB_SPI, RGB_SPD, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
